export function showSuccess(aiCredits, pdfCredits) {
...
export async function setPaymentEngine() {
    let buyButtons = document.querySelectorAll('.buy-credits');
    if (buyButtons.length === 0) return; // No buttons found, skip setting up the engine
