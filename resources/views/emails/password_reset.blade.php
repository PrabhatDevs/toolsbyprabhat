                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; background-color: #0d1117; border: 1px solid #7000ff33; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 25px rgba(112, 0, 255, 0.15);">
                    ...
                    <tr>
                        <td style="padding: 40px; color: #c9d1d9;">
                            <h2 style="color: #ffffff; font-size: 24px; margin-top: 0; margin-bottom: 20px; letter-spacing: 1px;">PASSWORD_RECOVERY_REQUEST</h2>
                            
                            <p style="font-size: 16px; line-height: 1.6; margin-bottom: 10px;">User Identity: <strong>{{ $email ?? '' }}</strong>,</p>
                            
                            <p style="font-size: 16px; line-height: 1.6; margin-bottom: 30px;">
                                The system has received a request to override existing credentials. To authorize a new <span style="color: #00f2fe; font-weight: bold;">Access Token</span> and reset your password, please proceed via the secure link below.
                            </p>
                            ...
                            <p style="font-size: 14px; color: #8b949e; line-height: 1.5; border-top: 1px solid #30363d; padding-top: 20px; margin-top: 20px;">
                                <strong style="color: #ff4d4d;">SECURITY_WARNING:</strong> This recovery transmission will expire in <strong>60 minutes</strong>. If you did not initiate this request, your account may be under investigation. No action is required to maintain current security protocols.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 20px 40px; background-color: #030712; text-align: center; border-top: 1px solid #7000ff22;">
                            <p style="font-size: 11px; color: #4b5563; margin: 0; text-transform: uppercase; letter-spacing: 1px;">
                                &copy; {{ date('Y') }} ToolsByPrabhat Portfolio Systems | Status: Recovery Pending
                            </p>
                        </td>
                    </tr>
                </table>
